...
class StatsModule:
    ...
    def calculate_statistics_per_coin(self, closed_trades):
        ...
        for pair, closed_pair_trades in trades_per_coin.items():
            ...
            per_coin_stats[pair]["win_weeks"], \
            per_coin_stats[pair]["draw_weeks"], \
            per_coin_stats[pair]["loss_weeks"], \
            market_change_weekly[pair] = get_winning_weeks_per_coin(
                self.frame_with_signals[pair],
            ...
            per_coin_stats[pair]["prof_weeks_loss"] = get_profitable_weeks_per_coin(
                seen_cum_profit_ratio_df
            )
