...
def test_return_no_trades():
    ...
    # Assert
    assert stats.coin_results[0].total_profit_percentage == 0
    assert stats.coin_results[0].cum_profit_percentage == 0
    assert stats.coin_results[0].avg_profit_percentage == 0
